...
<head>
    <meta charset="UTF-8">
    <title>会員情報</title>
    <link rel="stylesheet" href="../../css/informationEdit.css">
</head>
<body>
<div class="container">
<div class="navbar">
    ...
    <div class="section-container">
        ...
        <a href="editNameMenu.php"><button type="button">変更</button></a>
    </div>
    ...
    <div class="section-container">
        ...
        <a href="editAddressMenu.php"><button type="button">変更</button></a>
    </div>
    ...
    <div class="section-container">
        ...
        <a href="editContactMenu.php"><button type="button">変更</button></a>
    </div>
