...
$sql = "INSERT INTO product (productName, price, categoryNumber,storeCategoryNumber, stockQuantity, productDescription, dateAdded, releaseDate, storeNumber, pageDisplayStatus, imageNumber) VALUES
  ('ゆるかわ', 3850, 1, 1, 2000, ゆるっとかわいいが売りの服, '2024-09-03', '2024-09-03', 2, 1, null),
  ('かっこいい服', 6700, 2, 2, 6264,　暗めの色でとてもかっこよく見えます。, '2024-09-03', '2024-09-03', 2, 1, null),
  ('刺さると痛いネックレス', 16500, 4, 4, 100, イカツイファッションがお好きな女性向けのネックレスです。, '2024-09-03', '2024-09-03', 2, 1, null),
  ('アリアス　スマートウォッチ　フルタッチパネル　角型　ブラック', 4890, 5, 5, 8920, 歩数・心拍・血中酸素・他で健康管理。'2024-09-03', '2024-09-03', 2, 1, null),
  ('LIGE type-osyare', 37000, 6, 6, 1000, やすそうに見えて実際は高い男性向けの腕時計です。, '2024-09-03', '2024-09-03', 2, 1, null),
  ('ちょっとかっこいいネックレス', 7900, 7, 7, 8746545, 首にかけるだけで誰でも少しだけかっこよくなれます。, '2024-09-03', '2024-09-03', 2, 1, null),
  ('ゆめぴりか', 6000, 9, 9, 355467864, 北海道産のお米, '2024-09-03', '2024-09-03', 2, 1, null),
  ('岐阜県産　薄力粉', 1500, 9, 9, 989784735, 天ぷらやお菓子などの料理に適しています。, '2024-09-03', '2024-09-03', 2, 1, null),
  ('おいしいお菓子', 190, 10, 10, 27000, 一度食べると病みつきになります, '2024-09-03', '2024-09-03', 2, 1, null),
  ('惑星リンゴ', 16000, 11, 11, 10, 生産地が惑星の珍しいリンゴ, '2024-09-03', '2024-09-03', 2, 1, null),
  ('おいしいバナナ', 320, 11, 11, 9785465656, 黒くなりにくくておいしいバナナ, '2024-09-03', '2024-09-03', 2, 1, null),
  ('紫ブドウ', 600, 11, 11, 75638264, 一粒一粒に甘さが詰まっています, '2024-09-03', '2024-09-03', 2, 1, null),
  ('オレンジジュース', 100, 12, 12, 1452632265, 一般的なオレンジジュース, '2024-09-03', '2024-09-03', 1, 1, null),
  ('ウィルキンソン', 160, 13, 13, 735564126, 味がしない炭酸水。ほかのものと混ぜて飲むとおいしい, '2024-09-03', '2024-09-03', 1, 1, null),
  ('日本酒', 1940, 14, 14, 190027, この日本酒を飲んでしまうとどんな人も一瞬で酔っていしまいます。, '2024-09-03', '2024-09-03', 1, 1, null),
  ('赤霧島', 5600, 15, 15, 574256, これを飲むとモヤモヤが解消されます。, '2024-09-03', '2024-09-03', 1, 1, null),
  ('sharpのテレビ', 124000, 16, 16, 12000, 大画面で高画質のテレビ, '2024-09-03', '2024-09-03', 2, 1, null),
  ('任天堂スイッチ', 45300, 17, 17, 80000, みんなが大好き任天堂の最新ゲーム機, '2024-09-03', '2024-09-03', 2, 1, null),
  ('仮面ライダーベルト', 36900, 19, 19, 540000, 仮面ライダーダブルの変身ベルト, '2024-09-03', '2024-09-03', 2, 1, null),
  ('サッカーボール', 4000, 20, 20, 100000, このボールはほかのと違い、空気が抜けにくい, '2024-09-03', '2024-09-03', 2, 1, null),
  ('スポーツカー', 3850000, 22, 22, 80, こんなかっこいい車他にはありません!, '2024-09-03', '2024-09-03', 1, 1, null),
  ('イカツイバイク', 5130000, 23, 23, 700, これに乗ってるとモテるかも, '2024-09-03', '2024-09-03', 1, 1, null),
  ('ママチャリ', 36000, 24, 24, 90570, ちょっと大きめのママチャリです, '2024-09-03', '2024-09-03', 1, 1, null);";
$pdo->exec($sql);
