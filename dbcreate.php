...
$sql = "INSERT INTO product (productName, price, categoryNumber,storeCategoryNumber, stockQuantity, productDescription, dateAdded, releaseDate, storeNumber, pageDisplayStatus, imageNumber) VALUES
  ...
  ('オレンジジュース', 100, 12, 12, 1452632265, '一般的なオレンジジュース', '2024-09-03', '2024-09-03', 1, 1, 13),
  ('ウィルキンソン', 160, 13, 13, 735564126, '味がしない炭酸水。ほかのものと混ぜて飲むとおいしい', '2024-09-03', '2024-09-03', 1, 1, 14),
  ('日本酒', 1940, 14, 14, 190027, 'この日本酒を飲んでしまうとどんな人も一瞬で酔っていしまいます。', '2024-09-03', '2024-09-03', 1, 1, 15),
  ('焼酎', 5600, 15, 15, 574256, 'これを飲むとモヤモヤが解消されます。', '2024-09-03', '2024-09-03', 1, 1, 16),
  ('sharpのテレビ', 124000, 16, 16, 12000, '大画面で高画質のテレビ', '2024-09-03', '2024-09-03', 2, 1, 17),
  ('任天堂スイッチ', 45300, 17, 17, 80000, 'みんなが大好き任天堂の最新ゲーム機', '2024-09-03', '2024-09-03', 2, 1, 18),
