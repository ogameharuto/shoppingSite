...
$_SESSION['delivery_name'] = $firstname . " " . $lastname;
$_SESSION['delivery_name_kana'] = $firstname_kana . " " . $lastname_kana;
$_SESSION['delivery_address'] = $postal_code . " " . $prefecture . $address . $city . $building . " " . $phone;
...
if ($billingAddress === "その他住所を入力") {
    ...
    $_SESSION['delivery_name'] = $billing_firstname . " " . $billing_lastname;
    $_SESSION['billing_name_kana'] = $billing_firstname_kana . " " . $billing_lastname_kana;
    $_SESSION['billing_address'] = $billing_postal_code . " " . $billing_prefecture . $billing_address . $billing_city . $billing_building . " " . $billing_phone;
}
