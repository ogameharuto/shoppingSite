...
<body>
    ...
    <form id="registrationForm" action="newRegistrationMain.php" method="post" onsubmit="return validateForm()">
        ...
        <input type="text" id="furigana" name="furigana" placeholder="例: ヤマダ タロウ" required><br>
        ...
        <input type="text" id="postCode" name="postCode" placeholder="例: 100-0001" required><br>
        ...
        <input type="tel" id="telephoneNumber" name="telephoneNumber" placeholder="例: 03-1234-5678" required><br>
